...
> But Mana, I can't possibly read all of this!

> *Yes you can :face_with_raised_eyebrow: At the very least, read the pages I wrote about the various [node types](wwise/node_types.md) - all of them :knife:*
