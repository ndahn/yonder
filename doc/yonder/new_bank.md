...
| Type | Param | Fields |
| ---- | ----- | ------ |
| Character (sounds) | `NpcParam` | `AdditionalSoundBankId` |
| Character (dialog) | `TalkParam` | *TODO* |
| Map | `DefaultMapInfoParam` | `MapAdditionalSoundBankId` |
| Asset | `AssetEnvironmentGeometryParam` | `SoundBankId` |
| Cutscene | `SoundCutsceneParam`? | *TODO* |
...
- __Nightreign:__ The Revenant's family summons (e.g. Pumpkin Head: `c4340`), as well as the Executor's crucible beast (`c0100`), are always lodaed, and each can carry an additional soundbank via their `NpcParam`.
