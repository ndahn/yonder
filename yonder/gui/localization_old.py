...
class Localization:
    ...
    batch_sound_group_no_files: str = "Group {idx} ({name}) has no audio files"
...
def translate(key: str, default: Any = None, lang: Localization = None) -> str:
    if not lang:
        lang = Localization.active_lang
